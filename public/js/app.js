...
/* harmony export */ });
/* harmony import */ var _components_Box__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/Box */ "./resources/js/components/Box.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    if (cookieToken) {
      ...
      this.axios.get('/api/user/get').then(function (response) {
        if (response.data.authorized) {
          _this.authorizedState = response.data.authorized;

          _this.setHealth(response.data.tamagochi.health * 10);

          _this.setHunger(response.data.tamagochi.hunger * 10);

          _this.setFatigue(response.data.tamagochi.fatigue * 10);

          _this.setName(response.data.tamagochi.name);
        }
      });
    }
  },
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapState)('tamagochi', ['health', 'hunger', 'fatigue', 'name'])),
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapMutations)('tamagochi', ['setHealth', 'setHunger', 'setFatigue', 'setName'])), {}, {
    startGame: function startGame() {
      ...
      this.axios.post('/api/user/register', {
        ...
        if (response.data.authorized) {
          _this2.axios.defaults.headers['authorization'] = 'Bearer ' + response.data.token;
          _this2.authorizedState = response.data.authorized;

          _this2.$cookies.set('token', response.data.token);

          _this2.setHealth(response.data.tamagochi.health * 10);

          _this2.setHunger(response.data.tamagochi.hunger * 10);

          _this2.setFatigue(response.data.tamagochi.fatigue * 10);

          _this2.setName(response.data.tamagochi.name);
        }
      });
    },
...
/* harmony import */ var _modules_tamagochi__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/tamagochi */ "./resources/js/store/modules/tamagochi.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new vuex__WEBPACK_IMPORTED_MODULE_1__.default.Store({
  modules: {
    tamagochi: _modules_tamagochi__WEBPACK_IMPORTED_MODULE_2__.default
  },
  strict: false
}));
...
/***/ "./resources/js/store/modules/tamagochi.js":
/*!*************************************************!*\
  !*** ./resources/js/store/modules/tamagochi.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var mutations = {
  setHealth: function setHealth(state, health) {
    state.health = health;
  },
  setHunger: function setHunger(state, hunger) {
    state.hunger = hunger;
  },
  setFatigue: function setFatigue(state, fatigue) {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-8[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8[0].rules[0].use[2]!./resources/js/assets/css/style.css":
/*!***************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-8[0].rules[0].use[1]!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-8[0].rules[0].use[2]!./resources/js/assets/css/style.css ***!
  \***************************************************************************************************************************************************************************************************/
...
var render = function() {
  ...
  return _c("div", { staticClass: "card" }, [
    _c("div", { staticClass: "box" }, [
      _c("div", { staticStyle: { color: "white", "padding-bottom": "15px" } }, [
        _vm._v(_vm._s(_vm.name))
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "percent" }, [
        _c("svg", [
          _c("circle", { attrs: { cx: "70", cy: "70", r: "70" } }),
          _vm._v(" "),
          _c("circle", {
            style: {
              strokeDashoffset: "calc(440 - (440 * " + _vm.percent + ") / 100)"
            },
            attrs: { cx: "70", cy: "70", r: "70" }
          })
        ]),
        _vm._v(" "),
...
vue__WEBPACK_IMPORTED_MODULE_4__.default.use((vue_axios__WEBPACK_IMPORTED_MODULE_2___default()), (axios__WEBPACK_IMPORTED_MODULE_1___default()));
